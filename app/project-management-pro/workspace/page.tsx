...
const PRODUCT_ID = 'project-management-pro';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function ProjectManagementProWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Project Management Pro Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      requiredPlans={['PROJECT_MANAGEMENT_PRO', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Project Management Pro</h1>
                <p className="text-zinc-400">AI-Powered Project Planning Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Project Management Pro" 
                  docsLink="/products/project-management-pro/docs" 
                />
                <HotkeysHelp 
                  productName="Project Management Pro"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter project details or planning requirements..."
