...
const PRODUCT_ID = 'bundle-builder';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function BundleBuilderWorkspace() {
  ...
  const [parameters, setParameters] = useState<Record<string, any>>({
    ...
    discountStrategy: 'tiered',
    targetPlatform: 'gumroad',
    bundleSize: 3,
    targetRevenue: 10000,
    conversionOptimization: true,
    revenueMaximization: false,
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Bundle Builder Session
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-zinc-400">AI-Powered Product Bundle Creation Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Bundle Builder" 
                  docsLink="/products/bundle-builder/docs" 
                />
                <HotkeysHelp 
                  productName="Bundle Builder"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter your bundle concept or product theme..."
