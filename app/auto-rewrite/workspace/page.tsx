...
const PRODUCT_ID = 'auto-rewrite';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function AutoRewriteWorkspace() {
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Auto-Rewrite</h1>
                <p className="text-zinc-400">AI-Powered Content Rewriting Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Auto-Rewrite" 
                  docsLink="/products/auto-rewrite/docs" 
                />
                <HotkeysHelp 
                  productName="Auto-Rewrite"
