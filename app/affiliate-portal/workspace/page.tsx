...
export default function AffiliatePortalWorkspace() {
    ...
    try {
      ...
      const response = await fetch(`/api/${PRODUCT_ID}/run`, {
        ...
        body: JSON.stringify({
          ...
          params: { tone: 'professional', audience: 'business professionals' }
        })
      });
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Affiliate Portal Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Affiliate Portal"
      requiredPlans={['AFFILIATE_PORTAL', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-zinc-400">AI-Powered Affiliate Management Workspace</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter your affiliate content details..."
