...
const PRODUCT_ID = 'social-media-manager';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function SocialMediaManagerWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Social Media Manager Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      requiredPlans={['SOCIAL_MEDIA_MANAGER', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-zinc-400">AI-Powered Social Content Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Social Media Manager" 
                  docsLink="/products/social-media-manager/docs" 
                />
                <HotkeysHelp 
                  productName="Social Media Manager"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter social media topic or post concept..."
