...
const PRODUCT_ID = 'ecommerce-optimizer';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function EcommerceOptimizerWorkspace() {
    ...
    try {
      ...
      const response = await fetch(`/api/${PRODUCT_ID}/run`, {
        ...
        body: JSON.stringify({
          ...
          params: { keywords: [], targetLength: 300 }
        })
      });
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# E-commerce Optimizer Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="E-commerce Optimizer"
      requiredPlans={['ECOMMERCE_OPTIMIZER', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">E-commerce Optimizer</h1>
                <p className="text-zinc-400">AI-Powered Store Optimization Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="E-commerce Optimizer" 
                  docsLink="/products/ecommerce-optimizer/docs" 
                />
                <HotkeysHelp 
                  productName="E-commerce Optimizer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter product description or store content to optimize..."
