...
import ParameterControls from '@/components/toolkit/ParameterControls';

const PRODUCT_ID = 'content-spawner';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function ContentSpawnerWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Content Spawner Session
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Content Spawner</h1>
                <p className="text-zinc-400">AI-Powered Content Generation Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Content Spawner" 
                  docsLink="/products/content-spawner/docs" 
                />
                <HotkeysHelp 
                  productName="Content Spawner"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter your content brief or topic..."
