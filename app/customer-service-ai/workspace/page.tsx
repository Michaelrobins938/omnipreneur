...
export default function CustomerServiceAIWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Customer Service AI Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Customer Service AI"
      requiredPlans={['CUSTOMER_SERVICE_AI', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Customer Service AI</h1>
                <p className="text-zinc-400">AI-Powered Support Response Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Customer Service AI" 
                  docsLink="/products/customer-service-ai/docs" 
                />
                <HotkeysHelp 
                  productName="Customer Service AI"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter customer inquiry or support request..."
