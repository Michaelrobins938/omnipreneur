...
const PRODUCT_ID = 'email-marketing-suite';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function EmailMarketingSuiteWorkspace() {
    ...
    try {
      ...
      const response = await fetch(`/api/${PRODUCT_ID}/run`, {
        ...
        body: JSON.stringify({
          ...
          params: { audience: 'business professionals', tone: 'professional' }
        })
      });
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Email Marketing Suite Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      requiredPlans={['EMAIL_MARKETING_SUITE', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-zinc-400">AI-Powered Email Campaign Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Email Marketing Suite" 
                  docsLink="/products/email-marketing-suite/docs" 
                />
                <HotkeysHelp 
                  productName="Email Marketing Suite"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter email content or campaign details..."
