...
export default function SeoOptimizerProWorkspace() {
    ...
    try {
      ...
      const response = await fetch(`/api/${PRODUCT_ID}/run`, {
        ...
        body: JSON.stringify({
          ...
          params: { keywords: ['SEO', 'optimization'], targetLength: 300 }
        })
      });
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# SEO Optimizer Pro Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="SEO Optimizer Pro"
      requiredPlans={['SEO_OPTIMIZER_PRO', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">SEO Optimizer Pro</h1>
                <p className="text-zinc-400">Advanced SEO Content Optimization Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="SEO Optimizer Pro" 
                  docsLink="/products/seo-optimizer-pro/docs" 
                />
                <HotkeysHelp 
                  productName="SEO Optimizer Pro"
