...
export default function Blog() {
  ...
  const categories = [
    ...
    { id: 'ai', name: 'AI & Technology', count: 8 },
  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Discover how artificial intelligence is revolutionizing content creation and what it means for marketers, creators, and businesses in 2024.',
    ...
    {
      id: 2,
      title: '10 Proven Strategies for Viral Content',
      excerpt: 'Learn the science behind viral content and implement these proven strategies to boost your social media engagement.',
      author: 'Mike Chen',
      date: '2024-01-12',
      category: 'marketing',
      readTime: '8 min read',
      views: '1.8k',
      image: '/blog/viral-strategies.jpg'
    },
    {
      id: 3,
      title: 'How to Build a Successful Affiliate Program',
      excerpt: 'Step-by-step guide to creating and managing a profitable affiliate program that drives sales and builds partnerships.',
    ...
    {
      id: 4,
      title: 'Mastering the AutoRewrite Engine: A Complete Guide',
      excerpt: 'Comprehensive tutorial on using our AutoRewrite Engine to create engaging, SEO-optimized content at scale.',
      author: 'David Kim',
      date: '2024-01-08',
      category: 'tutorials',
      readTime: '15 min read',
      views: '4.2k',
      image: '/blog/autorewrite-guide.jpg'
    },
    {
      id: 5,
      title: 'Case Study: 300% Increase in Content Engagement',
      excerpt: 'How a SaaS company used our AI tools to triple their content engagement and drive more conversions.',
      author: 'Lisa Thompson',
      date: '2024-01-05',
      category: 'case-studies',
      readTime: '10 min read',
      views: '2.9k',
      image: '/blog/case-study-engagement.jpg'
    },
    {
      id: 6,
      title: 'The Psychology of High-Converting Landing Pages',
      excerpt: 'Understanding the psychological principles that make landing pages convert and how to apply them to your business.',
      author: 'Alex Martinez',
      date: '2024-01-03',
      category: 'marketing',
      readTime: '7 min read',
      views: '1.6k',
      image: '/blog/landing-page-psychology.jpg'
    }
  ];
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-800/60 border border-zinc-600/50 rounded-2xl px-12 py-4 text-white placeholder-zinc-400 focus:outline-none focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 transition-all duration-300"
                />
              </div>
            </motion.div>
          </motion.div>
      ...
      {filteredPosts.filter(post => post.featured).length > 0 && (
        <section className="py-20 relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Featured Post</h2>
            </motion.div>
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">{post.title}</h3>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="text-zinc-400 text-sm">{post.views} views</span>
                    </div>
