          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">Sample Blog Post {index}</h3>
                <p className="text-zinc-400 mb-4 leading-relaxed">
                  This is a sample blog post description that demonstrates the layout and styling of our blog section.
                </p>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-zinc-400 text-sm">1.2k views</span>
                </div>
