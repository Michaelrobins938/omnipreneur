...
const PRODUCT_ID = 'prompt-packs';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function PromptPacksWorkspace() {
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Prompt Packs"
      requiredPlans={['PROMPT_PACKS', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Prompt Packs</h1>
                <p className="text-zinc-400">AI Prompt Collection Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Prompt Packs" 
                  docsLink="/products/prompt-packs/docs" 
                />
                <HotkeysHelp 
                  productName="Prompt Packs"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter prompt theme or category to generate..."
