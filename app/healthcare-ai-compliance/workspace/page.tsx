...
export default function HealthcareAIComplianceWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Healthcare AI Compliance Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Healthcare AI Compliance"
      requiredPlans={['HEALTHCARE_AI_COMPLIANCE', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Healthcare AI Compliance</h1>
                <p className="text-zinc-400">Healthcare Content Compliance Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Healthcare AI Compliance" 
                  docsLink="/products/healthcare-ai-compliance/docs" 
                />
                <HotkeysHelp 
                  productName="Healthcare AI Compliance"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter healthcare content to check compliance..."
