...
const PRODUCT_ID = 'video-editor-ai';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function VideoEditorAIWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Video Editor AI Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Video Editor AI"
      requiredPlans={['VIDEO_EDITOR_AI', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Video Editor AI</h1>
                <p className="text-zinc-400">AI-Powered Video Script Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Video Editor AI" 
                  docsLink="/products/video-editor-ai/docs" 
                />
                <HotkeysHelp 
                  productName="Video Editor AI"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter video concept or script requirements..."
