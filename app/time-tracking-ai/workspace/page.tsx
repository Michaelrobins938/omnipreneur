...
export default function TimeTrackingAIWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Time Tracking AI Session
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Time Tracking AI</h1>
                <p className="text-zinc-400">AI-Powered Time Analysis Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Time Tracking AI" 
                  docsLink="/products/time-tracking-ai/docs" 
                />
                <HotkeysHelp 
                  productName="Time Tracking AI"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter time tracking data or analysis request..."
