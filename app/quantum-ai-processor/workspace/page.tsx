...
const PRODUCT_ID = 'quantum-ai-processor';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function QuantumAIProcessorWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Quantum AI Processor Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Quantum AI Processor"
      requiredPlans={['QUANTUM_AI_PROCESSOR', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Quantum AI Processor</h1>
                <p className="text-zinc-400">Advanced AI Processing Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Quantum AI Processor" 
                  docsLink="/products/quantum-ai-processor/docs" 
                />
                <HotkeysHelp 
                  productName="Quantum AI Processor"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter data or content to process with quantum AI..."
