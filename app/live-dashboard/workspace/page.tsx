...
const PRODUCT_ID = 'live-dashboard';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function LiveDashboardWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Live Dashboard Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      requiredPlans={['LIVE_DASHBOARD', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-zinc-400">Real-Time Analytics Dashboard Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Live Dashboard" 
                  docsLink="/products/live-dashboard/docs" 
                />
                <HotkeysHelp 
                  productName="Live Dashboard"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter dashboard content to update..."
