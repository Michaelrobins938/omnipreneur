...
const PRODUCT_ID = 'medical-ai-assistant';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function MedicalAIAssistantWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Medical AI Assistant Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Medical AI Assistant"
      requiredPlans={['MEDICAL_AI_ASSISTANT', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Medical AI Assistant</h1>
                <p className="text-zinc-400">AI-Powered Medical Response Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Medical AI Assistant" 
                  docsLink="/products/medical-ai-assistant/docs" 
                />
                <HotkeysHelp 
                  productName="Medical AI Assistant"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter medical inquiry or information request..."
