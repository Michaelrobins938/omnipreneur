...
const PRODUCT_ID = 'education-ai-compliance';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function EducationAIComplianceWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Education AI Compliance Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Education AI Compliance"
      requiredPlans={['EDUCATION_AI_COMPLIANCE', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Education AI Compliance</h1>
                <p className="text-zinc-400">Educational Content Compliance Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Education AI Compliance" 
                  docsLink="/products/education-ai-compliance/docs" 
                />
                <HotkeysHelp 
                  productName="Education AI Compliance"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter educational content to check compliance..."
