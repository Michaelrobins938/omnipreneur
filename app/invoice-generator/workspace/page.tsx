  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Invoice Generator Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      requiredPlans={['INVOICE_GENERATOR', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-zinc-400">AI-Powered Invoice Creation Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Invoice Generator" 
                  docsLink="/products/invoice-generator/docs" 
                />
                <HotkeysHelp 
                  productName="Invoice Generator"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter invoice details or billing information..."
