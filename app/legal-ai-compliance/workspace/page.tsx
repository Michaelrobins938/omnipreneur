...
const PRODUCT_ID = 'legal-ai-compliance';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function LegalAIComplianceWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Legal AI Compliance Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Legal AI Compliance"
      requiredPlans={['LEGAL_AI_COMPLIANCE', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Legal AI Compliance</h1>
                <p className="text-zinc-400">Legal Content Compliance Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Legal AI Compliance" 
                  docsLink="/products/legal-ai-compliance/docs" 
                />
                <HotkeysHelp 
                  productName="Legal AI Compliance"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter legal content to check compliance..."
