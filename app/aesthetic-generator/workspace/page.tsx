...
const PRODUCT_ID = 'aesthetic-generator';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function AestheticGeneratorWorkspace() {
    ...
    try {
      ...
      const response = await fetch(`/api/${PRODUCT_ID}/run`, {
        ...
        body: JSON.stringify({
          ...
          params: { variants: 3, format: 'article' }
        })
      });
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Aesthetic Generator Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Aesthetic Generator"
      requiredPlans={['AESTHETIC_GENERATOR', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Aesthetic Generator</h1>
                <p className="text-zinc-400">AI-Powered Design Creation Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Aesthetic Generator" 
                  docsLink="/products/aesthetic-generator/docs" 
                />
                <HotkeysHelp 
                  productName="Aesthetic Generator"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Describe your aesthetic vision or design concept..."
