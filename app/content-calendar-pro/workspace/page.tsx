...
export default function ContentCalendarProWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Content Calendar Pro Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Content Calendar Pro"
      requiredPlans={['CONTENT_CALENDAR_PRO', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Content Calendar Pro</h1>
                <p className="text-zinc-400">Advanced Content Planning Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Content Calendar Pro" 
                  docsLink="/products/content-calendar-pro/docs" 
                />
                <HotkeysHelp 
                  productName="Content Calendar Pro"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter your content theme or planning period..."
