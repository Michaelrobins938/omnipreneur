...
const PRODUCT_ID = 'podcast-producer';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function PodcastProducerWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Podcast Producer Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Podcast Producer"
      requiredPlans={['PODCAST_PRODUCER', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Podcast Producer</h1>
                <p className="text-zinc-400">AI-Powered Podcast Creation Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Podcast Producer" 
                  docsLink="/products/podcast-producer/docs" 
                />
                <HotkeysHelp 
                  productName="Podcast Producer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter podcast topic or episode concept..."
