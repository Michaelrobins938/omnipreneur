...
const PRODUCT_ID = 'auto-niche-engine';
const strategy = TOOL_STRATEGIES[PRODUCT_ID];

export default function AutoNicheEngineWorkspace() {
  ...
  const handleExport = async (format: 'json' | 'md') => {
    ...
    try {
      ...
      if (format === 'json') {
        ...
        content = `# Auto Niche Engine Session
...
`;
  ...
  return (
    <ProductAccessControl
      ...
      productName="Auto Niche Engine"
      requiredPlans={['AUTO_NICHE_ENGINE', 'PRO', 'ENTERPRISE']}
      demoMode={true}
    >
        ...
        <div className="max-w-8xl mx-auto px-6">
          <div className="mb-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-white">Auto Niche Engine</h1>
                <p className="text-zinc-400">AI-Powered Niche Discovery Workspace</p>
              </div>
              <div className="flex items-center space-x-3">
                <DocsShortcut 
                  productName="Auto Niche Engine" 
                  docsLink="/products/auto-niche-engine/docs" 
                />
                <HotkeysHelp 
                  productName="Auto Niche Engine"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <PromptEditor
                ...
                placeholder="Enter market or topic to analyze for niche opportunities..."
